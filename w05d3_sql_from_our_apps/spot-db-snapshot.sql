...
165	23	learning	How do you access secrets without storing those secrets in your git repository?	Use the 'dotenv' package to access environment variables instead. The secrets are kept in a file called .env and that file's context is transferred between teammates by some other mechanism.\r\n	5	\N	0	1	\N
166	\N	learning	What is a SQL Injection Attack?	untrusted text is forwarded directly to a SQL server	55	\N	\N	1	\N
167	\N	learning	q2	a2	42	\N	\N	1	\N
168	\N	performance	q3	q3	66	\N	\N	1	\N
\.
...
COPY public.sample (normal, "integer", "real", date, name) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.objectives_id_seq', 168, true);
